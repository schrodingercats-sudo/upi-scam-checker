#!/usr/bin/env python3
"""
🤖 ENHANCED SMS Scam Detection ML Model Trainer
Trained on ALL NEW DATASETS + existing data with advanced feature engineering
"""
...
class EnhancedSMSFeatureExtractor:
    """Enhanced feature extractor with 20+ engineered features."""
    ...
    def __init__(self):
        ...
        # New patterns for intimate scams
        self.intimate_patterns = [
            'hey, it\'s me', 'lost my wallet', 'can you upi', 'will return tomorrow'
        ]
    ...
    def _detect_intimate_scam(self, text_lower: str) -> bool:
        """Detect intimate scam patterns like 'lost wallet' scenarios."""
        return any(pattern in text_lower for pattern in self.intimate_patterns)
    ...
    def extract_features(self, text: str) -> List[float]:
        ...
        features = [
            ...
            self._detect_intimate_scam(text_lower),  # 13 intimate_scam_pattern
...
def train_enhanced_model():
    print("🚀 Starting ENHANCED SMS Scam Detection Model Training")
    print("📊 Using ALL NEW DATASETS + existing data")
    print("=" * 70)
    ...
    candidates = {
        ...
        'SVM': SVC(
            C=1.0, kernel='rbf', gamma='scale', random_state=42, class_weight='balanced', probability=True
        )
    }
    ...
    feature_names = [
        ...
        'official_sender', 'caps_percentage', 'intimate_scam_pattern', 'upi_specific_pattern',
    ...
    print(f"📁 Artifacts saved: sms_scam_model.pkl, sms_scam_scaler.pkl, feature_names.json, dataset_info.json")
